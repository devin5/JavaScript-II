...
function firstLastName(item, index){
...
// Problem 1
console.log("Problem 1 - For Each."); 
// The event director needs to have a list of all company names and email addresses for each item in the list. Print out this new array to the console. 
let compInfo = [];
runners.forEach(companyInfo);
function companyInfo(item, index){
      compInfo.push( ("Company Name: " + item.company_name + ". Email Address: " + item.email) + "." );
}
console.log(compInfo);

// Problem 2
console.log("Problem 2 - Map"); 
// The event director needs to have all the runner's last names converted to lowercase. Convert each first name into all caps and log the result.
let lower = runners.map(function(runner){
      return runner.last_name.toLowerCase();
});
console.log(lower);

// Problem 3
console.log("Problem 3 - Filter");
// The event direction needs to have a list of all people who dontated more than $200. Print out this list of large donators. 
let largeDonators = runners.filter(function(runner){
